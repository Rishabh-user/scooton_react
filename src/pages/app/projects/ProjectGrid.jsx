      ...
      <header className="flex justify-between items-end">
        ...
        <div>
          <Dropdown
            ...
            label={
              <span className="text-lg inline-flex flex-col items-center justify-center h-8 w-8 rounded-full bg-gray-500-f7 dark:bg-scooton-900 dark:text-slate-400">
          ...
          >
            <div>
              <Menu.Item onClick={() => handleClick(project)}>
                <div
                  className="hover:bg-scooton-900 dark:hover:bg-slate-600 dark:hover:bg-opacity-70 hover:text-white
