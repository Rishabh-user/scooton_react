      ...
      <div className="flex flex-wrap justify-between items-center mb-4">
        ...
        >
          <Button
            ...
            className={`${
              filler === "list"
                ? "bg-scooton-900 dark:bg-slate-700  text-white"
          ...
          <Button
            ...
            text="On going"
            className="bg-white dark:bg-slate-800 dark:text-slate-300 hover:bg-scooton-900 hover:text-white btn-md  h-min text-sm font-normal"
            iconClass=" text-lg"
          />
          <Button
