    ...
    <div className="h-full">
                  ...
                  <div className="no flex space-x-4 rtl:space-x-reverse">
                    <div className="opacity-0 invisible group-hover:opacity-100 group-hover:visible">
                      <Dropdown
                        ...
                        items={chatAction}
                        label={
                          <div className="h-8 w-8 bg-slate-300 dark:bg-scooton-900 dark:text-slate-400 flex flex-col justify-center items-center text-xl rounded-full text-slate-900">
                            <Icon icon="heroicons-outline:dots-horizontal" />
                          </div>
                        }
                      />
                    ...
                    <div className="whitespace-pre-wrap break-all">
                      <div className="text-contrent p-3 bg-slate-300 dark:bg-scooton-900 dark:text-slate-300 text-slate-800 text-sm font-normal rounded-md flex-1 mb-1">
                        {item.content}
                      </div>
      ...
      <footer className="md:px-6 px-4 sm:flex md:space-x-4 sm:space-x-2 rtl:space-x-reverse border-t md:pt-6 pt-4 border-slate-100 dark:border-slate-700">
        <div className="flex-none sm:flex hidden md:space-x-3 space-x-1 rtl:space-x-reverse">
          <div className="h-8 w-8 cursor-pointer bg-slate-100 dark:bg-scooton-900 dark:text-slate-400 flex flex-col justify-center items-center text-xl rounded-full">
        ...
        <div className="flex-1 relative flex space-x-3 rtl:space-x-reverse">
          ...
          <div className="flex-none md:pr-0 pr-3">
            <button
              type="button"
              className="h-8 w-8 bg-scooton-900 text-white flex flex-col justify-center items-center text-lg rounded-full"
            >
              <Icon
