    ...
    <div>
      <header>
        <div className="flex px-6 pt-6">
          ...
          <div className="flex-none">
            <div
              className="h-8 w-8 bg-slate-100 dark:bg-scooton-900 dark:text-slate-400 flex flex-col justify-center items-center text-xl rounded-full cursor-pointer"
          ...
          >
            <SimpleBar className="h-full p-6">
              <div className="text-right">
                <div
                  className="h-8 w-8 bg-slate-100 dark:bg-scooton-900 dark:text-slate-400 inline-flex ml-auto flex-col justify-center items-center text-xl rounded-full cursor-pointer"
