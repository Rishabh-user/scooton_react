        ...
        <div className="space-y-5">
          <div>
            ...
            <div className="flex flex-wrap space-xy-5">
              <div>
                <div className="color-box h-[96px] 2xl:w-[107px] w-[96px] bg-scooton-900 rounded-md flex flex-col text-white p-4 transition-all duration-200 hover:shadow-sm hover:-translate-y-1"></div>
