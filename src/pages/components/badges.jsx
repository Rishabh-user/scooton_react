    ...
    <div className="grid xl:grid-cols-2 grid-cols-1 gap-5">
      <Card title="Basic Badges">
        <div className="space-xy-5">
          ...
          <Badge
            label="Dark"
            className="bg-slate-800 dark:bg-scooton-900  text-white"
          />
        </div>
      </Card>
      <Card title="Pill Badges">
        <div className="space-xy-5">
          ...
          <Badge
            label="Dark"
            className="bg-slate-800 dark:bg-scooton-900 text-white pill"
          />
        </div>
      </Card>
      <Card title="Soft Badges">
        <div className="space-xy-5">
          ...
          <Badge
            label="Dark"
            className="bg-slate-800 dark:bg-scooton-900 text-slate-800 dark:text-slate-400 bg-opacity-[0.12]"
          />
        </div>
      </Card>
      <Card title="Soft Pill Badges">
        <div className="space-xy-5">
          ...
          <Badge
            label="Dark"
            className="bg-slate-800 dark:bg-scooton-900 text-slate-800 dark:text-slate-400 bg-opacity-[0.12] pill"
          />
        </div>
      </Card>
