            ...
            {steps.map((item, i) => (
              ...
              >
                <div
                  className={`${
                    stepNumber >= i
                      ? "bg-scooton-900 text-white ring-slate-900 ring-offset-2 dark:ring-offset-slate-500 dark:bg-scooton-900 dark:ring-slate-900"
                ...
                <div
                  className={`${
                    stepNumber >= i
                      ? "bg-scooton-900 dark:bg-scooton-900"
